...
function checkForAnswer() {
    ...
    options.forEach((option) => {
        if (option.checked === true && option.value === currentQuestionAnswer) {
            ...
            document.getElementById(wrongLabelId).style.backgroundColor = "#fb8072"
            document.getElementById(correctOption).style.backgroundColor = "#b3de69"
...
function handleEndGame() {
    ...
    if (playerScore <= 1) {
        remark = "Hard to guess!"
        remarkColor = "#fb8072"
    }
    else if (playerScore >= 2 && playerScore < 3) {
        remark = "Quite correct!"
        remarkColor = "#fdb462"
    }
